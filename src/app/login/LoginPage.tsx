    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--surface-raised)' }}>
      ...
      <div
        style={{
          ...
          flex: '0 0 45%',
          background:
            'linear-gradient(145deg, var(--sm-brand-dark) 0%, var(--sm-brand) 60%, oklch(62% 0.13 195) 100%)',
          padding: '48px 52px',
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 22, letterSpacing: '-0.03em' }}>
            SmallMetrics
          </span>
        </div>
        ...
        <div>
          ...
          <p style={{ fontSize: 15, opacity: 0.82, lineHeight: 1.6, maxWidth: 340 }}>
            Métricas claras para tomar mejores decisiones. Pensado para equipos pequeños que quieren
          ...
          {[
            {
              ...
              desc: 'Visualiza el rendimiento de tus sitios y campañas al instante.',
            },
            {
              icon: '🎯',
              title: 'Objetivos y conversiones',
              desc: 'Define metas de negocio y mide cuánto te acercas a ellas.',
            },
            {
              icon: '💡',
              title: 'Insights accionables',
              desc: 'Entiende qué canales, páginas y audiencias generan más valor.',
            },
          ].map(f => (
